...
alias dl='cd /mnt/data/Downloads'
alias db='cd /mnt/data/Dropbox'
alias dt='cd /mnt/data'
alias ex='vim -e'
alias cb='xclip -selection clipboard -display :1'
alias can='trash-put'
alias vp='vim $DROPBOX_DIR/Notes/passwords.vimc'
alias ep='vim -e $DROPBOX_DIR/Notes/passwords.vimc'
alias tz='trizen'
alias tzu='trizen -Syua --devel'

# new functions
alias lsmnt='mount | column -t'
alias upd='if [ "$(date +%u)" = 7 ]; then trizen -Syua --devel ; else sudo pacman -Su; fi'
